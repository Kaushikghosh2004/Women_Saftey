...
app.config['MAIL_USERNAME'] = 'kaushik3389@gmail.com'  # Replace with your email
app.config['MAIL_PASSWORD'] = 'Abc123'   # Replace with your email password
...
def send_sos():
    try:
        ...
        msg = Message('SOS Alert - Immediate Help Needed',
                      sender='kaushik3389@gmail.com',
                      recipients=['kaushikghoshkg04@gmail.com'])  # Recipient's email
...
def send_video():
    ...
    send_email(app.config['MAIL_USERNAME'], app.config['MAIL_PASSWORD'], 'Kaushikghoshkg04@gmail.com', 'Subject: Live Video File', 'Please find the attached live video file.', video_filename)
